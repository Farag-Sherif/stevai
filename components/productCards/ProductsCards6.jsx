    ...
    >
      ...
      <div className="card-product-info">
        ...
        <span className="price current-price">
          {calcFinalPrice(product).hasDiscount && (
            <span className="old-price">
              {locale === "ar"
                ? `ج.م ${calcFinalPrice(product).originalPriceWithTax.toFixed(2)}`
                : `EGP ${calcFinalPrice(product).originalPriceWithTax.toFixed(2)}`}
            </span>
          )}{" "}
          {locale === "ar"
            ? `ج.م ${calcFinalPrice(product).finalPrice.toFixed(2)}`
            : `EGP ${calcFinalPrice(product).finalPrice.toFixed(2)}`}
        </span>
