...
export default function AccountSidebar() {
  ...
  // Handle both with and without locale prefix (e.g. /ar/my-account vs /my-account)
  const path = typeof pathname === "string" ? pathname.replace(/^\/(ar|en)(\/|$)/, "$2").replace(/^\/?/, "/") : "";
      ...
      <div className="sidebar-account">
        ...
        <ul className="my-account-nav">
          <li>
            <Link
              href={`/my-account`}
              className={`my-account-nav-item ${path === "/my-account" ? "active" : ""}`}
            >
              <svg
                width={24}
                height={24}
          ...
          <li>
            <Link
              ...
              className={`my-account-nav-item ${path === "/my-account-orders" ? "active" : ""}`}
            >
              <svg
                width={24}
                height={24}
          ...
          <li>
            <Link
              ...
              className={`my-account-nav-item ${path === "/my-account-address" ? "active" : ""}`}
            >
              <svg
                width={24}
                height={24}
          ...
          <li>
            <a
              href="#"
              className={`my-account-nav-item ${path === "/login" ? "active" : ""}`}
              onClick={async (e) => {
                e.preventDefault();
                clearUser();
