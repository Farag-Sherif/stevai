                    ...
                    {isCartLoading ? (
                      ...
                      <div className="tf-mini-cart-items">
                        {cartProducts?.map((product, i) => {
                          ...
                          const detailHref = `/product-detail/${product.id}-${slugTitle}`;
                            ...
                            <div className="tf-mini-cart-info flex-grow-1">
                              ...
                              <div className="d-flex align-items-center justify-content-between flex-wrap gap-12">
                                ...
                                <div className="text-button">
                                  ...
                                  {locale === "ar"
                                    ? `ج.م ${(Number(product?.price) || 0).toFixed(2)}`
                  ...
                  <div className="tf-mini-cart-bottom-wrap">
                    <div className="tf-cart-totals-discounts">
                      ...
                      <h5 className="tf-totals-total-value">
                        {locale === "ar"
                          ? `ج.م ${(Number.isFinite(totalPrice) ? totalPrice : 0).toFixed(2)}`
                          : `EGP ${(Number.isFinite(totalPrice) ? totalPrice : 0).toFixed(2)}`}
                      </h5>
                    </div>
