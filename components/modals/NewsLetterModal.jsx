...
import { useNewsletterMutations } from "@/hooks/mutations/useNewsletterMutations";
export default function NewsLetterModal() {
  const pathname = usePathname();
  const locale = useLocale();
  const modalElement = useRef();
  const { subscribeMutation } = useNewsletterMutations();
  useEffect(() => {
            ...
            >
              <div id="subscribe-content">
                <input
                  ...
                  name="email"
                  id="subscribe-email"
                  placeholder={locale === "ar" ? "أدخل بريدك الإلكتروني" : "Enter your e-mail"}
                  required
                />
                <button
                  type="submit"
