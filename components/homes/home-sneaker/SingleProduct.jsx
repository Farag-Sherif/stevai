...
export default function SingleProduct() {
  ...
  const { quickViewItem, addProductToCart, isAddedToCartProducts, addToWishlist, isAddedtoWishlist, addToCompareItem, isAddedtoCompareItem, cartProducts, updateQuantity, removeFromWishlist } = useContextElement();
  return (
                  ...
                  <div className="tf-product-info-choose-option">
                    ...
                    <div>
                      <div className="tf-product-info-by-btn mb_10">
                        ...
                        <a
                          onClick={(e) => { e?.preventDefault?.(); if (isAddedtoWishlist(products44[4].id)) removeFromWishlist(products44[4].id); else addToWishlist(products44[4].id); }}
                          className={`box-icon hover-tooltip text-caption-2 wishlist btn-icon-action ${isAddedtoWishlist(products44[4].id) ? "active" : ""}`}
                        >
