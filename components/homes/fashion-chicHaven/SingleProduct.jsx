                ...
                <div className="tf-product-info-choose-option">
                  ...
                  <div>
                    <div className="tf-product-info-by-btn mb_10">
                      ...
                      <a
                        onClick={(e) => { e?.preventDefault?.(); if (isAddedtoWishlist(products44[1].id)) removeFromWishlist(products44[1].id); else addToWishlist(products44[1].id); }}
                        className={`box-icon hover-tooltip text-caption-2 wishlist btn-icon-action ${isAddedtoWishlist(products44[1].id) ? "active" : ""}`}
                      >
